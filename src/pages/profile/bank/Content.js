        ...
        <MyContent>
          ...
          <Grid container>
               ...
               <span className={classes.bottomLine}></span>
                      ...
                      color: "#0085FF" , top: "10px", right: "10px", cursor: "pointer"}} />
                              </MyInput>
                        ...
                        <AddNominee>
                         ...
                         <MyPara>
                         We will notify your nominee(s) in case your account becomes dormant
                                due to inactivity for more than a year, and you do not come back and 
                                do a reKYC.
                         </MyPara>
                         </SubContent>
                                </MyInputWrapper>
