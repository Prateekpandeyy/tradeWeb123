...
alignItems: "center"
    ...
    return(
        <ul className={classes.mainMenu}>
            <li className={`${splitLocation[1] === "" ? "myMenuActive" : ""} ${classes.myMobileSidebar}`}>
                <Link to ="/" className={classes.myNavMenu}>
                <img src={logoImg} className={classes.myNav} />
                </Link>
               <p className={classes.MyMenuLogo}>
                   Logo
               </p>
                </li>
                
                <li className={`${splitLocation[2] === "holding" ? "myMenuActive" : ""} ${classes.myMobileSidebar}`}>
                <Link to = "/tradeweb/trading" className={classes.myNavMenu}>
                  <img src={homeImg} className={classes.myNav} />
                 
                 
                  <p className={classes.MyMenuName}>
                   Tradeweb
               </p>
               </Link>
                </li>
                ...
                <li className={`${splitLocation[2] === "trading" ? "myMenuActive" : ""} ${classes.myMobileSidebar}`}>
                  ...
                  Trading
                    ...
                    <li className={`${splitLocation[2] === "ledger" ? "myMenuActive" : ""} ${classes.myMobileSidebar}`}>
                  ...
                  Ledger
                    ...
                    <li className={`${splitLocation[2] === "transaction" ? "myMenuActive" : ""} ${classes.myMobileSidebar}`}>
                 ...
                 confirmation
                    ...
                    <li className={`${splitLocation[2] === "margin" ? "myMenuActive" : ""} ${classes.myMobileSidebar}`}>
                       <Link to = "/tradeweb/transaction" title="Transaction" className={classes.myNavMenu}>
                    ...
                    <li className={`${splitLocation[2] === "request" ? "myMenuActive" : ""} ${classes.myMobileSidebar}`}>
                       <Link to = "/tradeweb/transaction" title="Transaction" className={classes.myNavMenu}>
